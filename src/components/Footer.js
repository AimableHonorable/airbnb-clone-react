      ...
      <div className="container">
        ...
        <div className="row justify-content-between border-top">
            ...
            <div className="col-md-4 text-end d-flex">
              ...
              <a className="py-1 px-2 footer-link text-decoration-underline" href="/" ><ImFacebook className="fs-6 mb-1"/></a>
              <a className="py-1 px-2 footer-link text-decoration-underline" href="/" ><RiTwitterFill className="fs-6 mb-1"/></a>
              <a className="py-1 px-2 footer-link text-decoration-underline" href="/" ><ImInstagram className="fs-6 mb-1"/></a>
            </div>
        </div>
      </div>
    </footer>
