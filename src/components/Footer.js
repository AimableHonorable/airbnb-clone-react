    ...
    <div className="container">
      ...
      <div className="row justify-content-between border-top">
          ...
          <div className="col-md-4 text-end d-flex">
            <a className="py-1 px-2 footer-link" href="" ><i className="fas fa-globe"></i> English (US)</a>
            <a className="py-1 px-2 footer-link" href="" ><i className="fas fa-dollar-sign"></i> USD</a>
            <a className="py-1 px-2 footer-link" href="" ><i className="fab fa-facebook-f"></i></a>
            <a className="py-1 px-2 footer-link" href="" ><i className="fab fa-twitter"></i></a>
            <a className="py-1 px-2 footer-link" href="" ><i className="fab fa-instagram"></i></a>
          </div>
     </div>
    </div>
